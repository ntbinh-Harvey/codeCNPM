...
public class SearchBillFrm extends javax.swing.JFrame {
    ...
    public SearchBillFrm(User user) {
        this.user = user;
        initComponents();
        jLabel3.setText("Xin chào " + user.getPosition() + " " + user.getFullname());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText() == null || jTextField1.getText().length() == 0) {
            JOptionPane.showMessageDialog(this, "Please input the bill id");
        }
        BillDAO bd = new BillDAO();
        Bill bill = bd.searchBill(Integer.parseInt(jTextField1.getText()));
        if(bill != null) {
            (new BillInfoFrm(user, bill)).setVisible(true);
            this.dispose();
        }
        else {
            JOptionPane.showMessageDialog(this, "Either the bill has been paid, or there are no bills with that id existed");
        }
